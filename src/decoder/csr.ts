...
export const csrDecoders: DecodeMode[] = [
  // 0x300 - mstatus
  {
    ...
    fields: [
      ...
      { low: 9, high: 10, name: 'VS', description: 'Vector State', value: ['Off', 'Initial', 'Clean', 'Dirty'] },
      { low: 11, high: 12, name: 'MPP', description: 'Machine Previous Privilege', value: ['U', 'VS', 'HS', 'M'] },
      { low: 13, high: 14, name: 'FS', description: 'Floating-point State', value: ['Off', 'Initial', 'Clean', 'Dirty'] },
      { low: 15, high: 16, name: 'XS', description: 'Extended State', value: ['Off', 'Initial', 'Clean', 'Dirty'] },
      ...
      { low: 32, high: 33, name: 'UXL', description: 'User XLEN', value: ['Not supported', '32', '64', 'Reserved'] },
      { low: 34, high: 35, name: 'SXL', description: 'Supervisor XLEN', value: ['Not supported', '32', '64', 'Reserved'] },
      { low: 36, name: 'SBE', description: 'Supervisor Byte Endian', value: ['Little endian', 'Big endian'] },
      { low: 37, name: 'MBE', description: 'Machine Byte Endian', value: ['Little endian', 'Big endian'] },
  ...
  // 0x301 - misa
  {
    ...
    fields: [
      ...
      { low: 62, high: 63, name: 'MXL', description: 'Machine XLEN', value: ['Not supported', '32', '64', 'Reserved'] },
    ],
  },
  // 0x302 - medeleg
  {
    ...
    fields: [
      ...
      { low: 10, name: 'EM', description: 'Environment call from M-mode', type: DecodeFieldType.CSR_RO0 },
